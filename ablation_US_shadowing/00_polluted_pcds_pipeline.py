...
if __name__ == '__main__':
    ...
    if 'get_camera_poses' in pipeline or 'all' in pipeline:
        ...
        subprocess.run(['python', '01_generate_camera_poses.py',
    ...
    if 'raycast' in pipeline or 'all' in pipeline:
        ...
        misc.create_list_init_deformed_for_raycasting(spines_root=root_paths_spines,
                                                                     list_spines=list_spines,
                                                                     save_to=list_paths_for_raycasting,
                                                                     num_deform=num_deform)

        subprocess.run(['python', '02_generate_partial_pointclouds_from_spine.py',
    ...
    if 'separate_spine_pc_into_vert' in pipeline or 'all' in pipeline:
        subprocess.run(['python', '03_separate_spine_pc_into_vertebrae.py',
    ...
    if 'create_h5_dataset' in pipeline or 'all' in pipeline:
        ...
        subprocess.run(['python', '04_get_list_vertebrae_in_folders.py',
                        '--root_path_vertebrae', root_paths_vertebrae,
        ...
        subprocess.run(['python', '04_create_dataset_for_shape_completion.py',
