...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--nr_points_per_partial_point_cloud",
        required=True,
        dest="nr_points_per_partial_point_cloud",
        help="Number of points per partial point cloud. This number is used for the sampling technique."
    )
    arg_parser.add_argument(
        "--nr_points_per_complete_point_cloud",
        required=True,
        dest="nr_points_per_complete_point_cloud",
        help="Number of points per complete point cloud. This number is used for the sampling technique."
    )
    arg_parser.add_argument(
        "--visualize_vertebrae",
        action="store_true",
    ...
    processAllVertebrae(list_path=args.vertebrae_list,
                        ...
                        nrPointsProPartialPC=int(args.nr_points_per_partial_point_cloud),
                        nrPointsProCompletePC=int(args.nr_points_per_complete_point_cloud),
                        )
