...
def saveToH5(fileName, stackedCropped, stackedComplete, stackedLabelmaps, labels, datasets_ids, nrSamplesPerClass=16):
    ...
    dset_labelmaps = vertebrae_file.create_dataset("labelmaps", data=stackedLabelmaps)
